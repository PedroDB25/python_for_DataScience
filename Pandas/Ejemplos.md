...
### Ejemplo 1: Crear una serie con las listas de edades y nombres, con nombres como index.
...
...
~~~
### Ejemplo 2: Crear un dataFrame con todos los datos que nos dan, con los nombres como indice.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
print(DFSobrinos)
#resultado
...
...
~~~
### Ejemplo 3: Obtener las dimensiones del DataFrame.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
...
~~~
presidents_df = pd.read_csv('https://sololearn.com/uploads/files/president_heights_party.csv', index_col='name')
print(presidents_df.shape) #(45, 5) dimensiones
print(presidents_df.shape[0]) #45 filas
print(presidents_df.shape[1]) #4 columnas
print(presidents_df.size) #180 campos
~~~
...
~~~
### Ejemplo 6: seleccionar varios por su index desde un nombre hasta otro.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
nom1='dante'
...
pato          5        97       1
~~~
### Ejemplo 7: buscar por la posicion del dato.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
posicion=3
...
Name antutu
~~~
### Ejemplo 8: Mostrar todas las columna.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
print(DFSobrinos.columns)
#resultado
Index(['edades', 'estatura', 'genero']
~~~
### Ejemplo 9: Utiliza la seleccion por index y muestra las tres primeras linea.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
print(DFSobrinos.loc[:,'edades':'estatura'].head(3))
#resultado
	edades  estatura
dante       1        41
gusti       2        72
anahi       3        80
~~~
### Ejemplo 10: Mostrar estadisticas basicas.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
print(DFSobrinos.min()) #Minimo
print(DFSobrinos.max()) #Maximo
print(DFSobrinos.mean()) #Media
print(DFSobrinos['edades'].quantile([0.25, 0.5, 0.75, 1])) #cuantiles 25, 50 , 75 y 100
print(DFSobrinos.var()) #varianza
print(DFSobrinos.std()) #Desviacion estandar
...
genero       0.518875
~~~
### Ejemplo 11: Usa el metodo .describe() para extraer estadistica basicas.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
...
freq              19
~~~
### Ejercicio 13: Mirar la media de los datos por genero.
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
...
~~~
### Ejemplo 14: Agregar por genero y mirar las edades, calculando su minimo, maximo y media.
En este ejemplo es necesario importar *numpy*
~~~
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
...
DicSobrinos = {'edades': Vedad,'estatura':Vestatura,'genero':Vgenero}
DFSobrinos=pd.DataFrame(DicSobrinos,Vnombres)
print(DFSobrinos.groupby('genero').agg({'edades': [np.median, np.mean],'estatura':    [min, max]}))
